...
Personal repository for Data Structures & Algorithms practice. Solutions written in **Python**, with occasional **JavaScript**.
...
```
dsa-study/
├── 01_warm_up/           # Flat — pure practice problems
│   └── star_pattern_triangle.py
├── 03_arrays/            # Each topic is a flat folder
│   ├── remove_duplicates.py
│   └── lc026_remove_duplicates_from_sorted_array.py
└── _template.py          # Starter template for new solutions
```

**File naming:**

- Study/practice files: `snake_case_problem_name.py` / `.js`
- LeetCode problems: `lc{NUMBER}_{problem_name}.py` / `.js`
